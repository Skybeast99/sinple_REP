...
def visit_rock(player_name, player_hp, player_money, player_ex, player_level, player_strength, player_potion, player_potion_1):
    ...
    if option == '1':
        ...
        visit_lavka(player_name, player_hp, player_money, player_ex, player_level, player_strength, player_potion, player_potion_1, inventory)
    elif option == '0':
        print('ВЫШЕЛ ИЗ ИГРЫ')
    else:
        visit_rock(player_name, player_hp, player_money, player_ex, player_level, player_strength, player_potion, player_potion_1)
    ...
    if battle == 'y':
        ...
        while True:
            ...
            if decision == 'w' and player_hp > 0 and enemy_hp > 0:
                ...
                if player_potion_1 in inventory:
...
def visit_lavka(player_name, player_hp, player_money, player_ex, player_level, player_strength, player_potion, player_potion_1, inventory):
    ...
    if shopping == 'q':
        if player_money < potion_prize_h:
            ...
            player_potion += 1
            inventory.append('player_potion')
        pause()
        visit_lavka(player_name, player_hp, player_money, player_ex, player_level, player_strength, player_potion, player_potion_1, inventory)    
    elif shopping == 'e':
        if player_money < potion_prize_s:
            ...
            player_potion_1 += 1
            inventory.append('player_potion_1')
        pause()
        visit_lavka(player_name, player_hp, player_money, player_ex, player_level, player_strength, player_potion, player_potion_1, inventory)
    elif shopping == 'r':
        if player_money < potion_prize_h:
